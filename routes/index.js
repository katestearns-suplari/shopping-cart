...
router.get('/api/v1/carts', (req, res, next) => {
 ...
 router.post('/api/v1/products', (req, res, next) => {
     const results = [];
     const data = {name: req.body.name, description: req.body.description, price: req.body.price, imgurl: req.body.imgurl};
     ...
     pg.connect(connectionString, (err, client, done) => {
         ...
         client.query('INSERT INTO products(name, description, price, imgurl) values($1, $2, $3, $4)', [data.name, data.description, data.price, data.imgurl]);
 ...
 router.put('/api/v1/products/:id', (req, res, next) => {
     ...
     pg.connect(connectionString, (err, client, done) => {
         ...
         const id = req.params.id
         client.query('UPDATE products SET name=($1), description=($2), price=($3), imgurl=($4) WHERE id=($5)', [data.name, data.description, data.price, data.imgurl, id])
